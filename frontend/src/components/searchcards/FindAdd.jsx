    ...
    <div>
      <div className="grid md:grid-cols-2 grid-cols-1 items-start md:gap-3 gap-1">
        <div>
          <div className="">
            <input
              className="border border-solid-grey rounded-md mb-10 p-2 w-3/4"
              type="text"
            ...
            />
            <button
              className="bg-secondary ml-10 p-2 rounded-md text-white hover:bg-white hover:text-primary hover:border hover:border-primary transition-all duration-300"
            >
              Tìm kiếm
            </button>
          </div>
                  ...
                  <li key={index} >
                    <div className="border-2 border-solid rounded-md shadow-sm p-3 m-2 hover:bg-slate-100">
                      ...
                      <div className="flex justify-between">
                        ...
                        <h3 className="italic">Khoảng cách: {item.distance}</h3>
                      </div>
                    </div>
                  </li>
                ))}
